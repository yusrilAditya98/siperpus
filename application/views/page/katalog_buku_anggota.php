                    ...
                    for (i = 0; i < data[0].length; i++) {
                        html += '<tr>' +
                            ...
                            `<td>
                                ...
                                <a href="../../sirkulasi/peminjaman/pinjam/${data[0][i].register}" class="btn btn-sm btn-success"><i
                                ...
                                <div class="modal fade" id="btnPinjamBuku` + data[0][i].register + `" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="btnDetailBukuLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="btnPinjamBukuLabel">Pinjam Buku</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
